...
from consumers.models.station import Station
...
class Line:
    ...
    def _handle_arrival(self, message):
        ...
        value = message.value()
        # print(f"line 37 arrival messages,{value}")
